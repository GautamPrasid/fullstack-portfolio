      ...
      <Container className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
              Software &amp; Full-Stack Developer based in <strong className="text-slate-200 font-medium">Pokhara, Nepal 🇳🇵</strong>. Building high-performance, beautiful, and accessible software experiences.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  aria-label={`Visit Prasid's ${social.name}`}
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          ...
          <p className="text-center sm:text-left">
            © {new Date().getFullYear()} <strong className="text-slate-200 font-medium">Prasid Gautam</strong>. All rights reserved. Built with{" "}
